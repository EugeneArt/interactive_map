...
from .views import CreateSchemeView, CreateMapImageView, DetailMapImageView, CreateBuildingView, CreateFloorView, CreateRoomView, RoomDetailView, FindPathView

urlpatterns = {
    url(r'^schemelist/$', CreateSchemeView.as_view(), name="create_scheme"),
    url(r'^imagelist/$', CreateMapImageView.as_view(), name="create_image"),
    url(r'^imagelist/(?P<pk>[0-9]+)/?$', DetailMapImageView.as_view(), name="detail_image"),
